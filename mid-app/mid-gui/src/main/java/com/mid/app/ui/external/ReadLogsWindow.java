...
import com.mid.app.ui.extras.LogRecordsListRenderer;
...
public class ReadLogsWindow extends JDialog {
	...
	private JList<String> logFilesList() {
		...
		final File[] selectedFiles = fileChooser.getCurrentDirectory().listFiles();
	...
	public void getSelectedFileName() {
		...
		BufferedReader br;
		try {
			final String getFileFrom = file.getAbsolutePath() + File.separator + selectedItem;
			...
			JOptionPane.showMessageDialog(new Frame(), e.getMessage(), JOptionPane.MESSAGE_PROPERTY,
