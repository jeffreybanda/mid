 ...
 * @Date 15/07/2017
 */
package com.mid.app.ui.external;
...
public class NewReservationWindow extends JDialog {
	...
	private final String[] COUNTRY_LIST = { "Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra",
			...
			"Israel", "Islands",
			"Italy", "Jamaica", "Japan", "Republic of Korea", "Kuwait", "Lebanon", "Malaysia", "Mexico", "Nigeria",
			"Poland",
			"Portugal", "Puerto Rico,PR", "Qatar", "Romania", "Russian Federation", "Saudi Arabia", "Singapore",
			"Spain", "Sweden",
			"Switzerland", "Syrian Arab Republic", "Thailand", "Tunisia", "Turkey", "Turkmenistan", "Ukraine",
			"United Arab Emirates",
			"United Kingdom", "United States", "Uruguay", "Uzbekistan", "Virgin Islands U.S.", "Yemen", "Zambia",
			"Zimbabwe" };
	...
	public NewReservationWindow() {
		...
		final JLabel rezIdLbl = new JLabel("Reservation Id : ");
		...
		final JLabel nameSurnameLbl = new JLabel("Name  & Surname : ");
		...
		final JLabel checkinLbl = new JLabel("Checkin : ");
		...
		final JLabel lblCheckout = new JLabel("Checkout : ");
		...
		final JLabel reservationStatusLbl = new JLabel("Reservation Status : ");
		...
		chancelBtn
				.setIcon(new ImageIcon(NewReservationWindow.class.getResource("/com/coder/hms/icons/login_clear.png")));
		...
		reportBtn.setIcon(
				new ImageIcon(NewReservationWindow.class.getResource("/com/coder/hms/icons/rezaerv_report.png")));
		...
		final JLabel roomLbl = new JLabel("Room");
		...
		final JButton btnNewButton = new JButton("Add new Payment");
		...
		btnNewButton.setIcon(
				new ImageIcon(NewReservationWindow.class.getResource("/com/coder/hms/icons/newReserv_payment.png")));
		...
		final JLabel lblAgencyRefNo = new JLabel("Agency ref no : ");
		...
		final JLabel lblReferanceNo = new JLabel("Referance no : ");
	...
	public ItemListener currencyActionListener() {
		final ItemListener ac = new ItemListener() {
	...
	public ActionListener roomTypeActionListener() {
		final ActionListener rta = new ActionListener() {
	...
	public ActionListener addRoomActionListener() {
		final ActionListener acl = new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				final Object[] row = new Object[] { roomNumber, roomType, personCount, val, currency };
	...
	public void setRezIdField(final long reservationId) {
	...
	public void setNameSurnameField(final String NameSurname) {
	...
	public void setTotalDaysField(final int totalDays) {
	...
	public void setCheckinDate(final String theCheckinDate) {
		final LocalDate localDate = LocalDate.parse(theCheckinDate);
	...
	public void setCheckoutDate(final String theCheckoutDate) {
	...
	public void setHostType(final String theHostType) {
	...
	public void setCreditType(final String theCreditType) {
	...
	public void setReservStatus(final String theReservStatus) {
	...
	public void setCustomerCountry(final String theCustomerCountry) {
	...
	public void setReservNote(final String theNote) {
	...
	public void setRoomNumber(final String theRoomNumber) {
	...
	public void setPersonCountSpinner(final int thePersonCount) {
	...
	public void setPriceOfRoom(final double thePrice) {
		this.priceField.setValue(thePrice);
	}

	public void setRoomCountTableRows(final Object[] tableRows) {
		this.roomCountModel.setRowCount(0);
		this.roomCountModel.addRow(tableRows);
	}

	public void setRoomInfoTableRows(final Object[] tableRows) {
		this.model.setRowCount(0);
		this.model.addRow(tableRows);
	}

	public void setEarlyPaymetTableRows(final Object[] tableRows) {
	...
	public void setAgencyRefNo(final String agencyRefNo) {
	...
	public void setReferanceNo(final String refNo) {
		this.referanceNoField.setText(refNo);
	}

	public void addActionListenerToUpdateBtn(final ActionListener listener) {
