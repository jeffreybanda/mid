...
public class DialogFrame extends JFrame {
	...
	public DialogFrame() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(DialogFrame.class.getResource(LOGOPATH)));
		...
		lblIcon = new JLabel("");
		lblIcon.setIcon(new ImageIcon(DialogFrame.class.getResource("/icons/dialogPane_question.png")));
